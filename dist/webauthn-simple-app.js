(function (global, factory) {
   ...
   (factory((global.WebAuthnSimpleApp = {})));
   ...
   var Msg = function () {
       ...
       _createClass(Msg, [{
           ...
           key: "decodeBinaryProperties",
           value: function decodeBinaryProperties() {}
           // throw new Error("not implemented");
           ...
           key: "encodeBinaryProperties",
           value: function encodeBinaryProperties() {}
           // throw new Error("not implemented");
           ...
           key: "toHumanString",
           value: function toHumanString(obj) {
   ...
   var ServerResponse = function (_Msg) {
       _inherits(ServerResponse, _Msg);

       function ServerResponse() {
           _classCallCheck(this, ServerResponse);

           var _this = _possibleConstructorReturn(this, (ServerResponse.__proto__ || Object.getPrototypeOf(ServerResponse)).call(this));

           _this.propList = ["status", "errorMessage", "debugInfo"];
           return _this;
       }
       ...
       _createClass(ServerResponse, [{
           ...
           value: function validate() {
               switch (this.status) {
                   ...
                   case "failed":
                       ...
                       checkTrue(this.errorMessage.length > 0, "errorMessage must be non-zero length when status is 'failed'");
                       checkOptionalType(this, "debugInfo", "object");
                       break;
           ...
           value: function decodeBinaryProperties() {
               ...
               if (_typeof(this.debugInfo) === "object") {
                   ...
                   this.debugInfo.authnrData.flags = new Set([].concat(_toConsumableArray(this.debugInfo.authnrData.flags)));
           ...
           value: function encodeBinaryProperties() {
               ...
               if (_typeof(this.debugInfo) === "object") {
                   ...
                   this.debugInfo.authnrData.flags = [].concat(_toConsumableArray(this.debugInfo.authnrData.flags));
   ...
   var CreateOptionsRequest = function (_Msg2) {
       _inherits(CreateOptionsRequest, _Msg2);

       function CreateOptionsRequest() {
           _classCallCheck(this, CreateOptionsRequest);

           var _this2 = _possibleConstructorReturn(this, (CreateOptionsRequest.__proto__ || Object.getPrototypeOf(CreateOptionsRequest)).call(this));

           _this2.propList = ["username", "displayName", "authenticatorSelection", "attestation"];
           return _this2;
       }

       _createClass(CreateOptionsRequest, [{
           key: "validate",
           value: function validate() {
   ...
   var CreateOptions = function (_ServerResponse) {
       _inherits(CreateOptions, _ServerResponse);

       function CreateOptions() {
           _classCallCheck(this, CreateOptions);

           var _this3 = _possibleConstructorReturn(this, (CreateOptions.__proto__ || Object.getPrototypeOf(CreateOptions)).call(this));

           _this3.propList = _this3.propList.concat(["rp", "user", "challenge", "pubKeyCredParams", "timeout", "excludeCredentials", "authenticatorSelection", "attestation", "extensions"]);
           return _this3;
       }

       _createClass(CreateOptions, [{
           key: "validate",
           value: function validate() {
               _get(CreateOptions.prototype.__proto__ || Object.getPrototypeOf(CreateOptions.prototype), "validate", this).call(this);
   ...
   var CredentialAttestation = function (_Msg3) {
       _inherits(CredentialAttestation, _Msg3);

       function CredentialAttestation() {
           _classCallCheck(this, CredentialAttestation);

           var _this4 = _possibleConstructorReturn(this, (CredentialAttestation.__proto__ || Object.getPrototypeOf(CredentialAttestation)).call(this));

           _this4.propList = ["rawId", "id", "response", "getClientExtensionResults"];
           return _this4;
       }

       _createClass(CredentialAttestation, [{
           key: "validate",
           value: function validate() {
           ...
           value: function from(obj) {
               obj = _get(CredentialAttestation.__proto__ || Object.getPrototypeOf(CredentialAttestation), "from", this).call(this, obj);

               // original response object is probably read-only
               if (_typeof(obj.response) === "object") {
   ...
   function stringifyType(obj, key, depth) {
       ...
       switch (_typeof(obj[key])) {
           ...
           case "symbol":
               return obj[key].toString();
           default:
               throw new TypeError("unknown type in stringifyType: " + _typeof(obj[key]));
       }
       ...
       switch (true) {
           ...
           case obj[key] instanceof Set:
               return stringifyArr([].concat(_toConsumableArray(obj[key])), depth);
   ...
   function abToHumanStr(buf, depth) {
       ...
       // check the arguments
       if (typeof depth != "number" || (typeof buf === "undefined" ? "undefined" : _typeof(buf)) != "object") {
   ...
   var GetOptionsRequest = function (_Msg4) {
       _inherits(GetOptionsRequest, _Msg4);

       function GetOptionsRequest() {
           _classCallCheck(this, GetOptionsRequest);

           var _this5 = _possibleConstructorReturn(this, (GetOptionsRequest.__proto__ || Object.getPrototypeOf(GetOptionsRequest)).call(this));

           _this5.propList = ["username", "displayName"];
           return _this5;
       }

       _createClass(GetOptionsRequest, [{
           key: "validate",
           value: function validate() {
               checkFormat(this, "username", "non-empty-string");
               checkFormat(this, "displayName", "non-empty-string");
   ...
   var GetOptions = function (_ServerResponse2) {
       _inherits(GetOptions, _ServerResponse2);

       function GetOptions() {
           _classCallCheck(this, GetOptions);

           var _this6 = _possibleConstructorReturn(this, (GetOptions.__proto__ || Object.getPrototypeOf(GetOptions)).call(this));

           _this6.propList = _this6.propList.concat(["challenge", "timeout", "rpId", "allowCredentials", "userVerification", "extensions"]);
           return _this6;
       }

       _createClass(GetOptions, [{
           key: "validate",
           value: function validate() {
               _get(GetOptions.prototype.__proto__ || Object.getPrototypeOf(GetOptions.prototype), "validate", this).call(this);
               checkFormat(this, "challenge", "base64url");
               checkOptionalFormat(this, "timeout", "positive-integer");
   ...
   var CredentialAssertion = function (_Msg5) {
       _inherits(CredentialAssertion, _Msg5);

       function CredentialAssertion() {
           _classCallCheck(this, CredentialAssertion);

           var _this7 = _possibleConstructorReturn(this, (CredentialAssertion.__proto__ || Object.getPrototypeOf(CredentialAssertion)).call(this));

           _this7.propList = ["rawId", "id", "response", "getClientExtensionResults"];
           return _this7;
       }

       _createClass(CredentialAssertion, [{
           key: "validate",
           value: function validate() {
               checkFormat(this, "rawId", "base64url");
               checkOptionalFormat(this, "id", "base64url");
           ...
           value: function encodeBinaryProperties() {
               ...
               if (this.response.userHandle) {
                   if (this.response.userHandle.byteLength > 0) this.response.userHandle = coerceToBase64Url(this.response.userHandle, "response.authenticatorData");else this.response.userHandle = null;
               }
           }
       }], [{
           key: "from",
           value: function from(obj) {
               obj = _get(CredentialAssertion.__proto__ || Object.getPrototypeOf(CredentialAssertion), "from", this).call(this, obj);
   ...
   var WebAuthnOptions = function (_Msg6) {
       _inherits(WebAuthnOptions, _Msg6);

       function WebAuthnOptions() {
           _classCallCheck(this, WebAuthnOptions);

           var _this8 = _possibleConstructorReturn(this, (WebAuthnOptions.__proto__ || Object.getPrototypeOf(WebAuthnOptions)).call(this));

           _this8.propList = ["timeout"];
           return _this8;
       }

       _createClass(WebAuthnOptions, [{
           key: "merge",
           value: function merge(dst, preferDst) {
               var i;
   ...
   if ((typeof module === "undefined" ? "undefined" : _typeof(module)) === "object" && module.exports) {
       exp = module.exports;
       coerceToBase64Url = function coerceToBase64Url(thing, name) {
           name = name || "''";
           ...
           if ((typeof thing === "undefined" ? "undefined" : _typeof(thing)) === "object" && thing.buffer instanceof ArrayBuffer && !(thing instanceof Buffer)) {
               thing = thing.buffer;
           }
       ...
       coerceToArrayBuffer = function coerceToArrayBuffer(buf, name) {
           name = name || "''";
   ...
   if (isBrowser()) {
       ...
       coerceToArrayBuffer = function coerceToArrayBuffer(thing, name) {
           if (typeof thing === "string") {
               // base64url to base64
   ...
   function checkType(obj, prop, type) {
       switch (typeof type === "undefined" ? "undefined" : _typeof(type)) {
           case "string":
               if (_typeof(obj[prop]) !== type) {
                   throw new Error("expected '" + prop + "' to be '" + type + "', got: " + _typeof(obj[prop]));
               }
               break;
   ...
   function checkFormat(obj, prop, format) {
       switch (format) {
           case "non-empty-string":
               ...
               checkTrue(obj[prop].length > 0, "expected '" + prop + "' to be non-empty string");
               break;
           case "base64url":
               checkType(obj, prop, "string");
               checkTrue(isBase64Url(obj[prop]), "expected '" + prop + "' to be base64url format, got: " + obj[prop]);
               break;
           case "positive-integer":
               checkType(obj, prop, "number");
               var n = obj[prop];
               checkTrue(n >>> 0 === parseFloat(n), "expected '" + prop + "' to be positive integer");
               break;
           case "nullable-base64":
               var t = _typeof(obj[prop]);
               if (obj[prop] === null) t = "null";
               checkTrue(["null", "string", "undefined"].includes(t), "expected '" + prop + "' to be null or string");
               if (!obj[prop]) return;
               checkTrue(isBase64Url(obj[prop]), "expected '" + prop + "' to be base64url format, got: " + obj[prop]);
               break;
           default:
   ...
   function checkUserVerification(val) {
       checkTrue(["required", "preferred", "discouraged"].includes(val), "userVerification must be 'required', 'preferred' or 'discouraged'");
   }
   ...
   function checkAuthenticatorSelection(obj) {
       ...
       if (obj.authenticatorSelection && obj.authenticatorSelection.authenticatorAttachment) {
           checkTrue(["platform", "cross-platform"].includes(obj.authenticatorSelection.authenticatorAttachment), "authenticatorAttachment must be either 'platform' or 'cross-platform'");
       }
   ...
   function checkCredentialDescriptorList(arr) {
       arr.forEach(function (cred) {
           ...
           if (cred.transports) cred.transports.forEach(function (trans) {
               checkTrue(["usb", "nfc", "ble"].includes(trans), "expected transport to be 'usb', 'nfc', or 'ble', got: " + trans);
           });
       });
   }

   function checkAttestation(obj) {
       if (obj.attestation) checkTrue(["direct", "none", "indirect"].includes(obj.attestation), "expected attestation to be 'direct', 'none', or 'indirect'");
   }
   ...
   var WebAuthnApp = function () {
       function WebAuthnApp(config) {
           _classCallCheck(this, WebAuthnApp);
           ...
           if (window.PublicKeyCredential === undefined || typeof window.PublicKeyCredential !== "function" || typeof window.PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable !== "function") {
       ...
       _createClass(WebAuthnApp, [{
           ...
           value: function register() {
               ...
               fireRegister("start");
               // get challenge
               return this.requestRegisterOptions().then(function (serverMsg) {
                   return _this9.create(serverMsg);
               }).then(function (newCred) {
                   return _this9.sendRegisterResult(newCred);
               }).then(function (msg) {
           ...
           value: function login() {
               ...
               var self = this;
               // get challenge
               return this.requestLoginOptions().then(function (serverMsg) {
                   return self.get(serverMsg);
               }).then(function (assn) {
                   return self.sendLoginResult(assn);
               }).then(function (msg) {
                   fireLogin("success");
                   return msg;
               }).catch(function (err) {
           ...
           value: function create(options) {
               ...
               return navigator.credentials.create(args).then(function (res) {
                   // save client extensions
                   if (typeof res.getClientExtensionResults === "function") {
                       var exts = res.getClientExtensionResults();
                       if ((typeof exts === "undefined" ? "undefined" : _typeof(exts)) === "object") res.getClientExtensionResults = exts;
                   }
           ...
           value: function get(options) {
               ...
               return navigator.credentials.get(args).then(function (res) {
                   // save client extensions
                   if (typeof res.getClientExtensionResults === "function") {
                       var exts = res.getClientExtensionResults();
                       if ((typeof exts === "undefined" ? "undefined" : _typeof(exts)) === "object") res.getClientExtensionResults = exts;
           ...
           key: "requestRegisterOptions",
           value: function requestRegisterOptions() {
               var sendData = CreateOptionsRequest.from({
                   username: this.username,
                   displayName: this.displayName || this.username
               });

               return this.send(this.registerChallengeMethod, this.registerChallengeEndpoint, sendData, CreateOptions);
           }
           ...
           key: "sendRegisterResult",
           value: function sendRegisterResult(pkCred) {
               ...
               return this.send(this.registerResponseMethod, this.registerResponseEndpoint, sendData, ServerResponse);
           }
           ...
           key: "requestLoginOptions",
           value: function requestLoginOptions() {
               var sendData = GetOptionsRequest.from({
                   username: this.username,
                   displayName: this.displayname || this.username
               });

               return this.send(this.loginChallengeMethod, this.loginChallengeEndpoint, sendData, GetOptions);
           }
           ...
           key: "sendLoginResult",
           value: function sendLoginResult(assn) {
               ...
               return this.send(this.loginResponseMethod, this.loginResponseEndpoint, msg, ServerResponse);
           }
           ...
           key: "send",
           value: function send(method, url, data, responseConstructor) {
               // check args
               if (method !== "POST") {
               ...
               if (typeof url !== "string") {
                   return Promise.reject(new Error("expected 'url' to be 'string', got: " + (typeof url === "undefined" ? "undefined" : _typeof(url))));
               }
               ...
               if (typeof responseConstructor !== "function") {
                   return Promise.reject(new Error("expected 'responseConstructor' to be 'function', got: " + (typeof responseConstructor === "undefined" ? "undefined" : _typeof(responseConstructor))));
               }
   ...
   exports.WebAuthnHelpers = WebAuthnHelpers;
   exports.Msg = Msg;
   exports.ServerResponse = ServerResponse;
   exports.CreateOptionsRequest = CreateOptionsRequest;
   exports.CreateOptions = CreateOptions;
   exports.CredentialAttestation = CredentialAttestation;
   exports.GetOptionsRequest = GetOptionsRequest;
   exports.GetOptions = GetOptions;
   exports.CredentialAssertion = CredentialAssertion;
   exports.WebAuthnOptions = WebAuthnOptions;
   exports.WebAuthnApp = WebAuthnApp;
